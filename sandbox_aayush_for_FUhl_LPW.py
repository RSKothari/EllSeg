...
# -*- coding: utf-8 -*-
"""
Created on Thu May 28 00:13:23 2020
...
from utils import generateImageGrid, points_to_heatmap,Logger
...
if __name__=='__main__':
    ...
    logger = Logger(os.path.join('.',cond_name+'testdataset_pupilcenter_ground_truth.log'))
#%%
...
#        I, mask, spatialWeights, distMap, pupil_center, iris_center, elPts, elNorm, cond, imInfo = data
        ...
        for i in range (I.shape[0]):
          #saving Images
#            print (i)
            img=Image.fromarray(normalize_image(I[i][0].numpy()))
            logger.write ('{}/{}/{}'.format(str(counter),str(pupil_center[i][0].numpy()),str(pupil_center[i][1].numpy())))
...
#            img=Image.fromarray(np.uint8(image_current))
            img.save('/media/aaa/hdd/ALL_model/giw_e2e/Dataset/testdataset/'+cond_name+'/'+str(counter)+'.png')
