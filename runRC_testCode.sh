    ...
    do
        ...
        do
            ...
            do
                ...
                baseJobName="RC_e2e_${test_mode_${model}_${curObj_list[i]}_${selfCorr}_${disentangle}"
                ...
                sbatch -J ${baseJobName} -o "rc_log/${test_mode}/${baseJobName}.o" -e "rc_log/${test_mode}/${baseJobName}.e" --mem=16G --cpus-per-task=9 -p debug -A riteyes --gres=gpu:p4:2 -t 0-5:0:0 command.lock
            done
        done
    done
done